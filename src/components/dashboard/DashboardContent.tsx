...
const Content: Statistics[] = [
  { label: 'Active Projects', stat: 24, verdict: '12% from last month', trend: 'positive' },
  { label: 'Total Tasks', stat: 156, verdict: '8% from last month', trend: 'positive' },
  { label: 'Team Members', stat: 43, verdict: 'No change', trend: 'neutral' },
  { label: 'Completion Rate', stat: 87, verdict: '5% from last month', trend: 'negative' },
];
...
const DashboardContent: React.FC = () => {
  ...
  return (
    <section
      className={`rounded-b-xl p-8 ${
        mode === 'dark' ? 'bg-[#1f1f1f]' : 'bg-white'
      }`}
    >
        ...
        {Content.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`text-xs font-medium ${trendColors[item.trend]}`}
              >
